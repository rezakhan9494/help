...
--observations:No installments,dsc table entry present(need to delete)--

--Need to check if demands exist--
select * from egbs_demand_v1 where consumercode='BP-BAM-2022-06-29-005539' and  businessservice='BPA.NC_SAN_FEE';
select * from egbs_demand_v1 where consumercode='BP-BAM-2022-06-22-004994' and  businessservice='BPA.NC_SAN_FEE';

--If demands also not exists, then We need to send back one step these two applications--
