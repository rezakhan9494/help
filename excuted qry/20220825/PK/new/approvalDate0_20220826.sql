...
update eg_bpa_dscdetails set documenttype=null,documentid=null where buildingplanid = (select id from eg_bpa_buildingplan ebb where applicationno='BP-CTC-2022-07-23-006490');
...
update eg_bpa_dscdetails set documenttype=null,documentid=null where buildingplanid = (select id from eg_bpa_buildingplan ebb where applicationno='BP-CTC-2022-08-03-007081');
...
update eg_bpa_dscdetails set documenttype=null,documentid=null where buildingplanid = (select id from eg_bpa_buildingplan ebb where applicationno='BP-CTC-2022-06-23-005066');