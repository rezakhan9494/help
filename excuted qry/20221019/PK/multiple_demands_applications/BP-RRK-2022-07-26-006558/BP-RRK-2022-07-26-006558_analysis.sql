...
select * from egcl_bill where consumercode='BP-RRK-2022-07-26-006558' and businessservice ='BPA.NC_SAN_FEE';--count=0
select * from egcl_billdetial eb2 where billid in
(select id from egcl_bill where consumercode='BP-RRK-2022-07-26-006558' and businessservice ='BPA.NC_SAN_FEE');--count=0
