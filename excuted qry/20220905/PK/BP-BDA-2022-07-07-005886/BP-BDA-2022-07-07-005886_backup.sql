-------BP-BDA-2022-07-07-005886 noc backup
select * from eg_noc where sourcerefid ='BP-BDA-2022-07-07-005886' and noctype='NMA_NOC';
select * from eg_noc_document end2 where nocid =
(select id from eg_noc where sourcerefid ='BP-BDA-2022-07-07-005886' and noctype='NMA_NOC');




--------duplicate docs deletion backup for BP-BDA-2022-07-07-005886
