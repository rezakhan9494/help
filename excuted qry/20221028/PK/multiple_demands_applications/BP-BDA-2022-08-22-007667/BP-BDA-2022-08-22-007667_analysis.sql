...
select * from egbs_demand_v1 where consumercode='BP-BDA-2022-08-22-007667' and businessservice=
...
select * from egbs_billdetail_v1 where consumercode='BP-BDA-2022-08-22-007667' and businessservice=
...
select * from egcl_bill where consumercode='BP-BDA-2022-08-22-007667' and businessservice ='BPA.NC_SAN_FEE';--count=0
select * from egcl_billdetial eb2 where billid in
(select id from egcl_bill where consumercode='BP-BDA-2022-08-22-007667' and businessservice ='BPA.NC_SAN_FEE');--count=0
